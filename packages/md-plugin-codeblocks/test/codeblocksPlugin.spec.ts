...
\`\`\`
    ...
    expect(renderedHTML).toContain(
      '<pre v-pre class="markdown-code language-js">'
    );
...
\`\`\`
    ...
    expect(renderedHTML).toContain(
      '<q-tab-panel class="q-pa-none" name="Two (numbered)">'
    );
    expect(renderedHTML).toContain(
      '<q-tab-panel class="q-pa-none" name="Three (with diff)">'
    );
...
\`\`\`
    ...
    expect(renderedHTML).toContain(
      '<q-tab-panel class="q-pa-none" name="Another Empty Tab">'
    );
