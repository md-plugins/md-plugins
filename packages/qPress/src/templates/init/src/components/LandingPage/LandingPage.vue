        ...
        <div class="hero__visual">
          <div class="preview-panel">
            <div class="preview-panel__header">
              ...
              <span class="preview-panel__note">Plugin-powered docs</span>
            </div>
...
.landing-page {
  ...
  --landing-highlight-border: var(--qpress-highlight-border);
  --landing-highlight-bg: var(--qpress-highlight-bg);
  --landing-highlight-value: var(--qpress-highlight-value);
  --landing-highlight-label: var(--qpress-highlight-label);
  --landing-accent-line: var(--qpress-accent-line);
  --landing-icon-bg: var(--qpress-icon-bg);
  --landing-icon-color: var(--qpress-icon-color);
  --landing-tile-border: var(--qpress-tile-border);
  --landing-tile-bg: var(--qpress-tile-bg);
  --landing-tile-hover-border: var(--qpress-tile-hover-border);
  --landing-tile-hover-bg: var(--qpress-tile-hover-bg);
  --landing-tile-hover-shadow: var(--qpress-tile-hover-shadow);
