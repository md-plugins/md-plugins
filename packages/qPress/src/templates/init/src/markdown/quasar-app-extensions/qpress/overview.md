...
::: warning
Q-Press is for Quasar Vite projects using `@quasar/app-vite` `>=3.0.0-beta.44` at this time. TypeScript processing is also required. Do not use if you are using Webpack or have a JavaScript-only project.
:::
