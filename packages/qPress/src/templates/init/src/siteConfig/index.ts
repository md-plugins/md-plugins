  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        { name: 'Quick Start', path: '/quasar-app-extensions/qpress/quick-start' },
        { name: 'Installation', path: '/quasar-app-extensions/qpress/installation' },
        { name: 'Site Config', path: '/quasar-app-extensions/qpress/site-config' },
        { name: 'Navigation', path: '/quasar-app-extensions/qpress/navigation' },
        { name: 'Landing Page', path: '/quasar-app-extensions/qpress/landing-page' },
        { name: 'Themes', path: '/quasar-app-extensions/qpress/themes' },
        { name: 'Search', path: '/quasar-app-extensions/qpress/search' },
        { name: 'Markdown Features', path: '/quasar-app-extensions/qpress/markdown-features' },
        { name: 'Banners + Campaigns', path: '/quasar-app-extensions/qpress/banners-campaigns' },
        { name: 'Privacy Consent', path: '/quasar-app-extensions/qpress/privacy-consent' },
        { name: 'CodePen', path: '/quasar-app-extensions/qpress/codepen' },
...
const config = {
  ...
  publicUrl: 'https://md-plugins.netlify.app/',
  version: version,
  copyright: {
