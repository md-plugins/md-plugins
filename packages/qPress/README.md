...
> Current beta release: `0.1.0-beta.26`.
>
> Q-Press currently targets Quasar Vite projects using `@quasar/app-vite` `>=3.0.0-beta.42`. TypeScript processing is required.
