...
Some content.
    ...
    expect(env.toc).toEqual([{ id: 'custom-slug-custom-header', title: 'Custom Header' }])
  })
...
> Quoted content.
    ...
    expect(env.toc).toEqual([{ id: 'nested-subheading', title: 'Nested Subheading' }])
  })
...
#### Too deep
    ...
    expect(env.toc).toEqual([{ id: 'sub-subheading-1-1', title: 'Sub-subheading 1.1' }])
  })
})
