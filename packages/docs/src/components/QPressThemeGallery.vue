...
const themes: ThemePreview[] = [
  ...
  {
    name: 'Copperline',
    tagline: 'Warm editorial guides',
    description: 'A cream, espresso, and copper palette for premium long-form docs.',
    palette: {
      primary: '#b86535',
      secondary: '#6d4b34',
      accent: '#d58a45',
      medium: '#9b765d',
      lightBorder: 'rgba(184, 101, 53, 0.78)',
      darkBorder: 'rgba(213, 138, 69, 0.64)',
      lightBg: '#fff8ef',
      lightText: '#39271d',
      lightCodeBg: '#f2dfca',
      lightCodeText: '#4d3324',
      darkBg: '#1e1511',
      darkText: '#f4dec8',
      darkCodeBg: '#321f18',
      darkCodeText: '#f7dbc0',
      shadow: 'rgba(184, 101, 53, 0.22)',
    },
  },
  {
    name: 'Mystic',
  ...
  {
    name: 'Signal',
    tagline: 'Precise technical systems',
    description: 'A slate, cyan, and blue palette for fast-scanning API docs.',
    palette: {
      primary: '#38bdf8',
      secondary: '#334155',
      accent: '#22d3ee',
      medium: '#64748b',
      lightBorder: 'rgba(56, 189, 248, 0.7)',
      darkBorder: 'rgba(34, 211, 238, 0.62)',
      lightBg: '#f8fbff',
      lightText: '#132033',
      lightCodeBg: '#eef6ff',
      lightCodeText: '#12304f',
      darkBg: '#07111f',
      darkText: '#dbeafe',
      darkCodeBg: '#0d1b2e',
      darkCodeText: '#c7e6ff',
