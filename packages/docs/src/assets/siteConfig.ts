...
export const ecoSystemLinks = [
  {
    name: 'Ecosystem',
    about: 'Other projects that can help your development',
    children: [
      {
        label: 'QCalendar',
        icon: mdiCalendar,
...
export default {
  ...
  logoConfig: {
    ...
    showText: true,
    showVersion: true,
    logoLight: '/Markdown-logo.png',
    logoDark: '/Markdown-logo.png',
    logoAlt: '@md-plugins',
    logoText: '@md-plugins',
  } as LogoConfig,
  config: {
  ...
  links: {
    ...
    versionLinks: [...versionLinks] as SiteMenuItem[],
