...
The `0.1.0` beta line supports direct Markdown-it and Vite plugin usage in Vue/Vite projects. The Quasar app extensions in this repo target Quasar Vite projects using `@quasar/app-vite` `>=3.0.0-beta.35`. Repository development and CI use Node.js `>=22.13` and `pnpm@11.4.0`.
