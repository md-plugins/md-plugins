...
The current release-candidate line in this repository is `0.1.0-rc.1`. Packages in this line publish to npm under the `latest` dist-tag while Quasar app-vite is in its release-candidate window.
